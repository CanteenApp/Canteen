...
* Put a space after `function` and before the paramaters.
    ```javascript
    // good:
...
* We recommend using the [JSCS linter](http://jscs.info) and the static code analysis tool [JSHint](http://jshint.com).
